  ...
  return (
    <div className="flex md:flex-row flex-col text-center md:text-left w-full items-center justify-center border-b-gray-300 border-b last:border-0 px-5 md:px-0">
      ...
      <div className="md:w-4/6 pt-10 pb-5 md:pb-10">
        ...
        <p className="text-base font-sans-medium">{props.children}</p>
      </div>
  ...
  return (
    <div>
      ...
      <div className="lg:max-w-screen-lg max-w-xs sm:max-w-screen-sm md:max-w-screen-md mx-auto">
        <div className="flex justify-center mt-20" id="lessons">
          <Button
            variant="dark"
        ...
        <div className="flex flex-col max-w-4xl mt-20 bg-white mx-auto rounded-xl drop-shadow-md">
          <LessonCard
            ...
            link="/learn/web3-video/lesson/introduction-to-web3"
          >
            Introduction to the Web3 course material and how to navigate the
            course.
          </LessonCard>
          <LessonCard
            title="Why Polygon?"
            lesson="2"
            link="/learn/web3-video/lesson/why-polygon"
          >
            Learn about how Polygon works and the advantages of using the
            Polygon network.
          </LessonCard>
          <LessonCard
            title="What is Web3?"
            lesson="3"
            link="/learn/web3-video/lesson/what-is-web3-video"
          >
            Explore the evolution from Web1, to Web2, to Web3 and the
            capabiliies Web3 brings to the internet
          </LessonCard>
          <LessonCard
            title="Core ideas of Web3"
            lesson="4"
            link="/learn/web3-video/lesson/core-ideas-of-web3"
          >
            Discover the core ideas that Web3 is built on and the technologies
            the enable it.
          </LessonCard>
          <LessonCard
            title="DApps, NFTs and Tokens"
            lesson="5"
            link="/learn/web3-video/lesson/dapps-nfts-tokens"
          >
            Learn about DApps, NFTs and tokens that make up the Web3 space and
            the use cases these have.
          </LessonCard>
        </div>
